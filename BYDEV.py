...
#-----------------------------------------------
      ...
      #-------------Fungsi Speedbot Finish---------------------#
            ...
            #SC BACKUP BY Nugraharin buat selingan sc copy ya '-'
...
def FancyName():
    while True:
        try:
            ...
            time.sleep(4)
            profile = cl.getProfile()
            profile.displayName = "30%"
            cl.updateProfile(profile)
            time.sleep(4)
            profile = cl.getProfile()
            profile.displayName = "40%"
            cl.updateProfile(profile)
            time.sleep(4)
            profile = cl.getProfile()
            profile.displayName = "50%"
            cl.updateProfile(profile)
            time.sleep(4)
            profile = cl.getProfile()
            profile.displayName = "60%"
            cl.updateProfile(profile)
            time.sleep(4)
            profile = cl.getProfile()
            profile.displayName = "70%"
            cl.updateProfile(profile)
            time.sleep(4)
            profile = cl.getProfile()
            profile.displayName = "80%"
            cl.updateProfile(profile)
            time.sleep(4)
            profile = cl.getProfile()
            profile.displayName = "90%"
            cl.updateProfile(profile)
            time.sleep(4)
            profile = cl.getProfile()
            profile.displayName = "100%"
            cl.updateProfile(profile)
            time.sleep(4)
            profile = cl.getProfile()
